package ch.dersalvador.MissingLinkProcessor;

import ch.dersalvador.MissingLinkProcessor.configuration.MissingLinkProcessorModell;
import ch.dersalvador.MissingLinkProcessor.dictionaryprocessor.XLDeployDictionaryProcessor;
import ch.dersalvador.MissingLinkProcessor.fileprocessors.*;
import ch.dersalvador.MissingLinkProcessor.framework.ARAWebserviceWrapper;
import ch.dersalvador.MissingLinkProcessor.framework.XLDeployDeployablePackageUploader;
import ch.dersalvador.MissingLinkProcessor.model.ConfigurationSet;
import ch.dersalvador.MissingLinkProcessor.model.Deployable;
import ch.dersalvador.MissingLinkProcessor.model.DeployableFile;
import ch.dersalvador.MissingLinkProcessor.model.VendorDelivery;
...
public class Processor 
{
	...
	ch.dersalvador.MissingLinkProcessor.configuration.MissingLinkProcessorModell MissingLinkProcessorModell;
	...
	private void createJIRADeploymentTicket(VendorDelivery delivery, MissingLinkProcessorModell MissingLinkProcessorModell, List<Deployable> ListOfdeployablesPerGroup) throws FileNotFoundException {
		// ./createDeploymentTicket.sh Summay AppDerSalvador AT '10.10.2017 10:10' Environments/DerSalvador/DER/AT3 Applications/DerSalvador/DER/abs/13.3.0.dersalvador.12
		int iExitValue;
