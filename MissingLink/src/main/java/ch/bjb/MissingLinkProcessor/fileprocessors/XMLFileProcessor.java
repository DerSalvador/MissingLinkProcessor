 ...
 *
 * @author u37792
 * @version  $Revision: #1 $, $Date: 2016/07/21 $
 */
public class XMLFileProcessor extends BaseFileProcessor
{
	...
	static Logger log = LogManager.getLogger(XMLFileProcessor.class);
	...
	public static void process(DeployableFile file,String workingDir, String OUTPUT_FOLDER, Charset charset)
	{
		...
		{
			log.error("processing of virtual .xml files " + file.getFile() + " is not yet implemented");
		}
